...
namespace Utilities {
   public static class Display
   {
      ...
      private static extern IntPtr SendMessage(
         IntPtr hWnd,
         UInt32 Msg,
         IntPtr wParam,# Turn display off by calling WindowsAPI.
# from: http://www.powershellmagazine.com/2013/07/18/pstip-how-to-switch-off-display-with-powershell/
Add-Type -TypeDefinition '
using System;
using System.Runtime.InteropServices;
...
}.GetNewClosure() #nugget: GetNewClosure() separates each instance of $frmBlank
...
[System.Windows.Forms.Screen]::AllScreens | % {
  ...
  $frmBlank.Bounds = $_.Bounds
  $frmBlank.WindowState = [System.Windows.Forms.FormWindowState]::Maximized
  $frmBlank.FormBorderStyle = [System# Turn display off by calling WindowsAPI.
# from: http://www.powershellmagazine.com/2013/07/18/pstip-how-to-switch-off-display-with-powershell/
Add-Type -TypeDefinition '
using System;
using System.Runtime.InteropServices;
...
[System.Windows.Forms.Screen]::AllScreens | % {
  ...
  $menuItem.add_Click({
    ...
    @($thisForm.Show,$thisForm.Hide)[$thisForm.Visible].Invoke()
    [System.Windows.Forms.Application]::DoEvents() #crucial to allow blank form to cover task bar
    $thisForm.BringToFront() #also crucial to cover task bar# Turn display off by calling WindowsAPI.
# from: http://www.powershellmagazine.com/2013/07/18/pstip-how-to-switch-off-display-with-powershell/
Add-Type -TypeDefinition '
using System;
using System.Runtime.InteropServices;
